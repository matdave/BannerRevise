...
namespace BannerRevised\v3\Elements\Snippet;
...
class Snippet
{
    ...
    public function run()
    {
        ...
        $c->leftJoin(AdPosition::class, 'Positions', '`Ad`.`id` = `Positions`.`ad`');
        ...
        foreach ($rows as $object) {
            ...
            if (!isset($sources[$row['source']])) {
                 ...
                 */
                if ($source = $this->modx->getObject(modMediaSource::class, $source)) {
